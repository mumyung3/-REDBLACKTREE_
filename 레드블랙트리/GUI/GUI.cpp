...
LRESULT CALLBACK WndProc(HWND hWnd, UINT message, WPARAM wParam, LPARAM lParam)
{
	...
	case WM_CREATE:
	{
		g_hLinePen = CreatePen(PS_SOLID, 2, RGB(0, 0, 0));
	...
	case WM_PAINT:
	{
		...
		if (g_tree.root != RedBlackTree::NIL) {
			DrawNode drawer;
			drawer.DrawingNode(hdc, g_tree.root, 700, 50, 350);
		}
